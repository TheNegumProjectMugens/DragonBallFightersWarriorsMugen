...
[State -1, Kamehameha Kaioken x20]
type = ChangeState
triggerall = var(2) = 5
...
type = ChangeState
triggerall = var(2) = 1 || (var(2) = 5 && var(3) = 1)
...
[State -1, Kamehameha]
type = ChangeState
Triggerall = ifelse(var(2) = 5,power >= 1500,power >= 1000)
value = 1400
...
Triggerall = power >= 1500
value = ifelse(pos y < 0,32580,32500)
